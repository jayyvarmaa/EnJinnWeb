...
export default function Dither({
  ...
  useEffect(() => {
    if (typeof window === 'undefined' || !wrapperRef.current || !('IntersectionObserver' in window)) {
      return;
    }
  ...
  const shouldAnimate = !disableAnimation && isVisible;

  return (
    <div ref={wrapperRef} className="dither-container" style={{ width: '100%', height: '100%', display: 'block' }}>
      <Canvas
